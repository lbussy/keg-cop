...
window.onclick = function (event) {
    ...
    if (typeof type === 'undefined' || type == "file" || type == "submit" || type == "reset" || type == "number" || type == "text" || type == "radio" || type == "textarea" || event.target.id == "noChange" || event.target.classList.contains('btn-close') || event.target.classList.contains('internal-action')) {
        return;
    }
